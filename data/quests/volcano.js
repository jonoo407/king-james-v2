  ...
  const scenes = [
    ...
    //     handled at voice-gen time). Beats split tight so each lands.
    {
      ...
      beats: [
        ...
        { speaker: 'crown', text: 'But he was my best student.' },
        { speaker: 'crown', text: 'A long, long time ago.' },
    ...
    // 16. ASK PATH — reveals more, then loops back to the meet.
    {
      ...
      beats: [
        ...
        { speaker: 'mornox',   text: 'I miss him every day.' },
        { speaker: 'james',    text: '...' },
    ...
    //     HIMSELF out loud (the inner half of the arc theme).
    {
      ...
      beats: [
        ...
        { speaker: 'mornox',   text: 'Four hundred years. I\'ve tried.' },
    ...
    // 22. Listen ending — the sun line. Best beat in the script.
    {
      ...
      beats: [
        ...
        { speaker: 'narrator', text: 'Sunlight on his face. First time in 400 years.' },
        { speaker: 'mornox',   text: 'Huh.' },
        { speaker: 'mornox',   text: 'Sun.' },
        { speaker: 'mornox',   text: 'I\'d forgotten.' },
        { speaker: 'crown',    text: 'Go on, old man. Go.' },
        { speaker: 'mornox',   text: 'Take the kettle, kid. Brew good.' },
      ],
      next: 'volcano_epilogue',
    },
    ...
    // 23. Group photo. Every shipped named character.
    {
      ...
      beats: [
        ...
        { speaker: 'wraith',   text: '*soft bow*' },
        { speaker: 'frostbeard',text: 'Aye. A king proper.' },
        { speaker: 'drifter',  text: 'The shore is gentle again.' },
        { speaker: 'widow',    text: 'My boats are out today.' },
        { speaker: 'finn',     text: 'CANNONBALL!' },
        { speaker: 'zephyra',  text: 'Old wizard\'s student. Well done.' },
